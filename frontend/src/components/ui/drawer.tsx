  ...
  "fixed z-50 flex flex-col bg-background outline-none",
  {
    variants: {
      direction: {
        ...
        bottom:
          "inset-x-0 bottom-0 mt-24 max-h-[96vh] rounded-t-[12px] border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
        left: "inset-y-0 left-0 h-full w-full border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-[560px]",
      },
    },
    defaultVariants: {
      direction: "bottom",
